...
pacman::p_load(tidyverse,
               ...
               readxl,
               kml,  
               zoo) # for lemmatisation and stemming    
```
...
gender_disparity %>%
  ggplot(aes(x = date, y = female_male_ratio)) + 
  geom_col(colour = "steelblue", width = 2) + 
  scale_x_date(breaks = c(as.Date("2020-02-01"), as.Date("2020-05-01"))) + 
  facet_wrap(~ main_industry, scales = "free_y") +
  theme_clear
